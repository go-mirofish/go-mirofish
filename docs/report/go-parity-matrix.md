...
| Simulation start/run | current alias contract from `docs/report/contract-matrix.md` |
| Simulation status | current alias contract from `docs/report/contract-matrix.md` |
| Report generate | `POST /api/report/generate` |
| Report generate status | current alias contract from `docs/report/contract-matrix.md` |
...
- ontology, graph build, simulation, and report generation can complete under the Go stack
