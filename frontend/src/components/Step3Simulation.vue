...
.platform-status.twitter .platform-icon { color: var(--doc-text); }
.platform-status.reddit .platform-icon { color: var(--doc-text); }
...
.icon-small.filled {
  color: var(--doc-muted); /* Keep icons neutral unless highlighted */
}
