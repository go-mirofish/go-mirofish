...
.badge.accent {
  background: var(--doc-accent-soft, rgba(0, 173, 216, 0.15));
...
.dimension-card:hover {
  background: var(--doc-workbench-mid);
  border-left-color: var(--doc-muted);
}
...
.spinner-sm {
  width: 16px;
  height: 16px;
  border: 2px solid var(--doc-border, #e5e5e5);
...
.posts-timeline {
  ...
  gap: 16px;
  padding-left: 8px;
  border-left: 2px solid var(--doc-border, #e5e7eb);
  margin-top: 12px;
}
...
.minimal-slider {
  ...
  border-radius: 2px;
  outline: none;
  background-image: linear-gradient(var(--doc-text, #000), var(--doc-text, #000));
...
.minimal-slider::-webkit-slider-thumb {
  ...
  border-radius: 50%;
  background: var(--doc-surface);
  border: 2px solid var(--doc-text, #111827);
  cursor: pointer;
...
.mark-recommend::after {
  ...
  width: 1px;
  height: 4px;
  background: var(--doc-border, #cbd5e1);
}
...
.auto-value {
  ...
  gap: 4px;
  padding-right: 24px;
  border-right: 1px solid var(--doc-border, #e2e8f0);
}
