<template>
  <div class="process-page">
    <!-- Top navigation -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">go-mirofish</div>
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph build will start automatically when ontology generation completes</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After upload, the LLM analyzes the documents and generates an ontology for the simulation surface, including entity types and relation types.
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API notes</div>
                <div class="detail-content">
                  Uses the generated ontology to chunk documents, call the Zep API, and build a knowledge graph of entities and relations.
                </div>
              </div>
...
const entityTypes = computed(() => {
  ...
  const typeMap = {}
  const colors = ['#00ADD8', '#004E89', '#7B2D8E', '#1A936F', '#C5283D', '#E9724C']
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending upload was found. Return to the home page and try again.'
    loading.value = false
    return
  }
...
const renderGraph = () => {
  ...
  const colorScale = d3.scaleOrdinal()
    .domain(types)
    .range(['#00ADD8', '#004E89', '#7B2D8E', '#1A936F', '#C5283D', '#E9724C', '#2D3436', '#6C5CE7'])
