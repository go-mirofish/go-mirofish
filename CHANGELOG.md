...
- update installation.md (For the public app ([gomirofish.vercel.app](h…
...
- update package.json ("https://go.mirofish.ai", → "https://gomirofish.…
- update package-lock.json ("^9.0.0" → "^9.0.0",)
...
- update ollama.md (go.mirofish.ai → [gomirofish.vercel.app](https://go…
