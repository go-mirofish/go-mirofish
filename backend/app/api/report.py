...
def get_report_sections(report_id: str):
    ...
    try:
        ...
        logger.error(f"Failed to fetch chapter list: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_single_section(report_id: str, section_index: int):
    ...
    try:
        ...
        logger.error(f"Failed to fetch chapter content: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_agent_log(report_id: str):
    ...
    try:
        ...
        logger.error(f"Failed to fetch agent logs: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
...
def get_console_log(report_id: str):
    ...
    try:
        ...
        logger.error(f"Failed to fetch console logs: {str(e)}")
        return jsonify({
            "success": False,
            "error": str(e),
            "traceback": traceback.format_exc()
